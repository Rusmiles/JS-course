...
// Нельзя использовать друг с другом
let num = 0;
for (; num < 5; num++) {
...
//Последний результат 0, верно? [нет, поскольку последняя итерация 0, а она в JS - всегда false, которая останавливает цикл и не отображает результат в консоли]
*/
