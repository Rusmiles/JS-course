/* Массивы - это отдельный подвид объектов, и он позволяет нам хранить данные, но в отличие от объектов управлять этими данными мы можем гораздо гибче. */
...
// Функция string делает то же самое, но разделитель всегда неизменяемый "," и не можем его указать:
...
/*
let value = arr.reduce(function(previousValue, item (элемент), index (ключ элемента), array (массив)) {
  // ...
}, [initial]);
*/
